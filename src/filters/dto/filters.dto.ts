...
export class FilterDto {
  ...
  @ApiProperty({
    required: false,
    description:
      'sort - Sorted-by corresponding to each sortby field, if single value, apply to all sortby fields. e.g. desc,asc …',
  })
  @IsOptional()
  @IsIn(['asc', 'desc'])
  ...
  @ApiProperty({
    required: false,
    description: 'orderBy - OrderBy fields. e.g. col1,col2 …',
  })
  @IsOptional()
  @IsString()
